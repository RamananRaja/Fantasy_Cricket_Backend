...
//JWT SECRET
const jwtSecret = "70779453980414983348jfnvdjfnkmdhdjfjfu414983348jfnvdj"
...
UserSchema.methods.toJSON = function() {
    ...
    //return the document except the password and session (these shouldn't be made availabe)
...
UserSchema.methods.generateRefreshAuthToken = function() {
    //This method simply generate a 64byte hex string - it doesn't save it to database. saveSessionToDatabase() does that.
    return new Promise((resolve, reject) => {
